...
class WechatInterfaceException extends Exception
{
    ...
    public function __construct($message, $code, History $history, Exception $previous = null)
    {
        $this->history = $history;
        parent::__construct($message, $code, $previous);
    }

    public function getChineseMessage()
    {
        if (isset(self::$errorCode[$this->code])) {
            return self::$errorCode[$this->code];
        } else {
            return $this->notDefinedMessage;
        }
    }
